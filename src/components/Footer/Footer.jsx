...
const Footer = ({className}) => {
  ...
  return (
    <footer className={['container', className, styles['footer']].join(' ')}>
      <div className={styles['footer__wrapper-features']}>
        <nav className={[styles['footer__nav'], styles['page-links']].join(' ')}>
          <LinkList
            links={pageLinks}
            classNameLink={[styles['page-links__link'], 'dm-sans-desktop-heading-5', 'gray-link'].join(' ')}
            classNameCurrentLink={'gray-link_current'}/>
        </nav>
        <form className={[styles['footer_email-form'], styles['email-form']].join(' ')}>
          <input className={[fontDMSans.className, styles['email-form__input'], 'dm-sans-desktop-heading-5'].join(' ')} type='text' placeholder='Give an email, get the newsletter.'/>
          <input value='' type="submit" className={styles['email-form__button']}/>
        </form>
      </div>
      <div className={styles['footer_wrapper-company-information']}>
        <p className={[styles['footer__copyright-title'], 'dm-sans-desktop-heading-5'].join(' ')} children={[
          '© 2021 Shelly. ',
          <LinkList
        ...
        <div className={[styles['footer__social-media-list'], styles['social-media-list']].join(' ')}>
          <a target='_blank' className={[styles['social-media-list__item'], styles['linked-in-icon']].join(' ')}
            ...
            <svg className={styles['social-media-list__image-svg']} width="19" height="18" viewBox="0 0 19 18"
                 fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className={styles['social-media-list__image-path']} fillRule="evenodd" clipRule="evenodd"
          ...
          <a target='_blank' className={[styles['social-media-list__item'], styles['facebook-icon']].join(' ')}
             href="https://www.facebook.com/">
            <svg className={styles['social-media-list__image-svg']} width="10" height="18" viewBox="0 0 10 18"
                 fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className={styles['social-media-list__image-path']}
          ...
          <a target='_blank' className={[styles['social-media-list__item'], styles['instagram-icon']].join(' ')}
             href="https://www.instagram.com/">
            <svg className={styles['social-media-list__image-svg']} width="18" height="18" viewBox="0 0 18 18"
                 fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className={styles['social-media-list__image-path']} fillRule="evenodd" clipRule="evenodd"
          ...
          <a target='_blank' className={[styles['social-media-list__item'], styles['twitter-icon']].join(' ')}
             href="https://twitter.com/">
            <svg className={styles['social-media-list__image-svg']} width="20" height="17" viewBox="0 0 20 17"
                 fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className={styles['social-media-list__image-path']}
